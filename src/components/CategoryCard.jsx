...
function CategoryCard({item}) {
  return (
    <div className='flex flex-col gap-8  bg-white rounded-lg shadow-xl hover:shadow-2xl group hover:scale-105 transition-smooth duration-500 max-w-[330px] sm:max-w-[40vw]'>
